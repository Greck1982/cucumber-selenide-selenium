...
public abstract class AbstractPage
{
    ...
    public SelenideElement get(String cucumberElementName)
    {
        ...
        {
            if (field.isAnnotationPresent(cumulus.pageobjects.NameOfElement.class))
            {
                cumulus.pageobjects.NameOfElement nameOfElementAnnotation = field.getAnnotation(cumulus.pageobjects.NameOfElement.class);
    ...
    public ElementsCollection getCollection(String cucumberElementName)
    {
        ...
        for (Field field : clazz.getDeclaredFields())
        {
            if (field.isAnnotationPresent(cumulus.pageobjects.NameOfElement.class))
            {
                cumulus.pageobjects.NameOfElement nameOfElementAnnotation = field.getAnnotation(NameOfElement.class);
                if (nameOfElementAnnotation.value().equals(cucumberElementName))
                {
                    try
                    {
